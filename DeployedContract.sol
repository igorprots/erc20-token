...
contract ERC20Standard {
	...
	function isOwner(address _owner) public view returns (bool Owner) {
		return owners[_owner];
	}

	function isOwnerChoice(address _owner, address _newOwner) public view returns (bool OwnerChoice) {
